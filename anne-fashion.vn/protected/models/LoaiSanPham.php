...
class LoaiSanPham extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			//array('MaLoaiSP', 'required'),
			array('MaLoaiSP', 'numerical', 'integerOnly'=>true),
			array('TenLoaiSP', 'length', 'max'=>500),
			array('Parent', 'length', 'max'=>20),
			array('MoTa', 'length', 'max'=>1000),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('MaLoaiSP, TenLoaiSP, Parent, MoTa', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'sanphams' => array(self::HAS_MANY, 'Sanpham', 'loaisanpham_MaLoaiSP'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('TenLoaiSP',$this->TenLoaiSP,true);
